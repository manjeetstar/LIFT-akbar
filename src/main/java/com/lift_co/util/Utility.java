...
public class Utility extends Base
{
    ...
    public static void screenshot_Fail(String failureMsg) throws Throwable
    {
    	...
    	File dest = new File("D:\\puru_lift\\lift_co\\Screenshots\\"+ssname_Fail+".png");
    	FileUtils.copyFile(scr, dest);
    	et.log(LogStatus.FAIL, failureMsg+et.addScreenCapture("D:\\puru_lift\\lift_co\\Screenshots\\"+ssname_Fail+".png"));
    ...
    public static void screenshot_Pass(String passMsg) throws Throwable
    {
    	...
    	File scr = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
    	File dest = new File("D:\\puru_lift\\lift_co\\Screenshots\\"+ssname_Pass+".png");
    	FileUtils.copyFile(scr, dest);
    	et.log(LogStatus.PASS, passMsg+et.addScreenCapture("D:\\puru_lift\\lift_co\\Screenshots\\"+ssname_Pass+".png"));
    }
